 ...
 * @author
 */
public class NspaymentChargeDepositDetail implements Serializable {
	...
	/** 业务标志财务科目,1|text|0|0|0,1|text|0||1|1 */
	@ApiModelProperty(value = "业务标志财务科目,1|text|0|0|0,1|text|0||1|1")
	private String subjectCode;
	
	/** 结算方式,1|text|0|0|0,1|text|0||1|1 */
	@ApiModelProperty(value = "结算方式,1|text|0|0|0,1|text|0||1|1")
	...
	/** 后余额,1|decimal|0|0|0,1|text|0||1|1 */
	@ApiModelProperty(value = "后余额,1|decimal|0|0|0,1|text|0||1|1")
