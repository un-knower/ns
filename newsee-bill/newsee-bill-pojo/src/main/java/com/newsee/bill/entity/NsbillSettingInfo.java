 ...
 * @author
 */
public class NsbillSettingInfo implements Serializable {
	...
	public void setPrecinctIdList(String precinctIdList) {
		this.precinctIdList = precinctIdList;
	}
	
	public String getPrecinctIdList() {
		return precinctIdList;
	}
