...
public class SystemRemoteServiceHystrix implements ISystemRemoteService {
    ...
    @Override
    public RestResult<Long> getOrgIdCompanyLevel( Long organizationId){
    	return null;
    }

    @Override
    public RestResult<List<NsSystemOrganizationVo>> listAllChildNode(Long organizationId, Integer orgType) {
        return null;
    }

    @Override
	public RestResult<String> findDictionaryName(Map<String, Object> map) {
		// TODO Auto-generated method stub
		return null;
	}
}
