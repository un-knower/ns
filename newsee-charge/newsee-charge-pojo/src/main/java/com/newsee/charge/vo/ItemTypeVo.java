...
public class ItemTypeVo implements Serializable {
	...
	/**
	 * @param goodsTaxId the goodsTaxId to set
	 */
	...
	/**
	 * @param goodsTaxCode the goodsTaxCode to set
	 */
