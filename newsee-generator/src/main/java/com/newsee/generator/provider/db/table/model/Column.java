...
import com.newsee.generator.GeneratorProperties;
import com.newsee.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.newsee.generator.util.ColumnHelper;
import com.newsee.generator.util.GLogger;
import com.newsee.generator.util.StringHelper;
import com.newsee.generator.util.TestDataGenerator;
import com.newsee.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.newsee.generator.util.typemapping.DatabaseDataTypesUtils;
import com.newsee.generator.util.typemapping.JavaPrimitiveTypeMapping;
import com.newsee.generator.util.typemapping.JdbcType;
/**
...
//			_table.getExportedKeys().addForeignKey(refTable.getSqlName(), hasMany.columnSqlName, getSqlName(), hasMany.columnSqlName.toLowerCase().hashCode());
	...
	private void initOtherProperties() {
        ...
        if(removedPrefixColName.indexOf("_") >= 0){
        	columnNameSource = columnName;
        }else{
        	columnNameSource = removedPrefixColName;
        }
        sqlTypeNameSource = getSqlTypeName();
    	sizeSource = getSize();
	...
	private String sqlTypeNameSource;
	private Integer sizeSource;
	//=== add by xiaosisi on 2018/01/17
	private String columnNameSource;
	public String getColumnNameSource() {
		return columnNameSource;
	}
	public void setColumnNameSource(String columnNameSource) {
		this.columnNameSource = columnNameSource;
	}

	public String getSqlTypeNameSource() {
		return sqlTypeNameSource;
	}

	public void setSqlTypeNameSource(String sqlTypeNameSource) {
		this.sqlTypeNameSource = sqlTypeNameSource;
	}
	...
	public void setSizeSource(Integer sizeSource) {
