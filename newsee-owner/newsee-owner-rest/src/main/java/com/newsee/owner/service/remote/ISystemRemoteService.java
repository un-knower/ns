...
import com.newsee.owner.service.remote.hystrix.SystemRemoteServiceHystrix;
...
//    public RestResult<NsCoreDictionaryVo> getDictionary(@RequestBody NsCoreDictionary dictionary);
    ...
    public RestResult<List<NsSystemRoleHouse>> getDataPermission(@RequestParam(value="userId", required=false) Long userId);
