 ...
 * @author
 */
public class SystemResourceFieldEntity implements Serializable {
	...
	/** whereSql */
	@ApiModelProperty(value = "whereSql")
	...
	/** 自定义验证方法 */
	@ApiModelProperty(value = "自定义验证方法")
